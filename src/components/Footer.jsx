      ...
      <footer className='bg-white'>
        <div className='mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8 lg:pt-24'>
          <div className='text-center'>
            <h2 className='text-3xl font-extrabold text-gray-900 sm:text-5xl'>VISA STARS</h2>
          ...
          <div className='mt-16 border-t border-gray-100 pt-8 sm:flex sm:items-center sm:justify-between lg:mt-24'>
            ...
            <div className=' border-t border-gray-100'>
              <p className='text-center text-xs/relaxed text-gray-500'>© Company 2022. All rights reserved.</p>
            </div>
            <ul className='mt-8 flex justify-center gap-6 sm:mt-0 lg:justify-end'>
              <li>
                <a rel='noreferrer' target='_blank' className='text-gray-700 transition hover:opacity-75'>
